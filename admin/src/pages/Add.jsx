...
const Add = ({token}) =>
{
  ...
  
  {
    ...
    try
    {
      ...
      // const image4 = document.getElementById( "image4" ).files[ 0 ] || null;
      ...
      //     console.log(`Skipped image${index + 1}`);
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <button className='w-28 py-3 bg-black mt-4 text-white md:full' type='submit'>Add</button>
